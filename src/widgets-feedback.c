/* widgets-feedback.c generated by valac 0.18.1, the Vala compiler
...
struct _Block2Data {
	...
	guint i;
	gint* temp_array;
	gint temp_array_length1;
	gint _temp_array_size_;
};
...
static void __lambda5_ (Block2Data* _data2_, GtkSpinButton* sbtn);
...
static void __lambda6_ (NSWidgetsFeedback* self);
static void ___lambda6__gtk_info_bar_response (GtkInfoBar* _sender, gint response_id, gpointer self);
...
static void __lambda7_ (NSWidgetsFeedback* self, GtkWidget* a);
...
static void ___lambda8__gtk_info_bar_response (GtkInfoBar* _sender, gint response_id, gpointer self);
...
static void block2_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data2_->_ref_count_)) {
		NSWidgetsFeedback * self;
		self = _data2_->self;
		_data2_->temp_array = (g_free (_data2_->temp_array), NULL);
...
static void __lambda5_ (Block2Data* _data2_, GtkSpinButton* sbtn) {
	...
	_tmp2_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, GTK_TYPE_ADJUSTMENT) ? ((GtkAdjustment*) _tmp1_) : NULL);
	adjust = _tmp2_;
	_tmp3_ = gtk_adjustment_get_value (adjust);
	...
	_g_free0 (_tmp5_);
	temp = _tmp7_;
	_data2_->temp_array[_data2_->i] = temp;
	_tmp8_ = _data2_->temp_array[_data2_->i];
	_tmp9_ = _data2_->i;
	_data2_->i = _tmp9_ + 1;
...
void on_btn_yes_clicked (GtkButton* button, GtkGrid* grid_crop, NSWidgetsFeedback* self) {
	...
	_tmp0_[2] = 0;
	_tmp0_[3] = 0;
	_data2_->temp_array = _tmp0_;
	_data2_->temp_array_length1 = 4;
	_data2_->_temp_array_size_ = _data2_->temp_array_length1;
	ns_widgets_feedback_update_resolution_on_cropping = TRUE;
	ns_widgets_feedback_question_was_asked = TRUE;
	_tmp1_ = grid_crop;
	_tmp2_ = gtk_grid_get_child_at (_tmp1_, 3, 0);
	_tmp3_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp2_, GTK_TYPE_SPIN_BUTTON) ? ((GtkSpinButton*) _tmp2_) : NULL);
	sbtn_list = g_list_append (sbtn_list, _tmp3_);
	_tmp4_ = grid_crop;
	_tmp5_ = gtk_grid_get_child_at (_tmp4_, 5, 1);
	_tmp6_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp5_, GTK_TYPE_SPIN_BUTTON) ? ((GtkSpinButton*) _tmp5_) : NULL);
	sbtn_list = g_list_append (sbtn_list, _tmp6_);
	_tmp7_ = grid_crop;
	_tmp8_ = gtk_grid_get_child_at (_tmp7_, 3, 2);
	_tmp9_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp8_, GTK_TYPE_SPIN_BUTTON) ? ((GtkSpinButton*) _tmp8_) : NULL);
	sbtn_list = g_list_append (sbtn_list, _tmp9_);
	_tmp10_ = grid_crop;
	_tmp11_ = gtk_grid_get_child_at (_tmp10_, 1, 1);
	_tmp12_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp11_, GTK_TYPE_SPIN_BUTTON) ? ((GtkSpinButton*) _tmp11_) : NULL);
	sbtn_list = g_list_append (sbtn_list, _tmp12_);
	g_list_foreach (sbtn_list, ___lambda5__gfunc, _data2_);
	_tmp13_ = _data2_->temp_array[0];
	ns_widgets_feedback_crop.top = _tmp13_;
	_tmp14_ = _data2_->temp_array[1];
	ns_widgets_feedback_crop.right = _tmp14_;
	_tmp15_ = _data2_->temp_array[2];
	ns_widgets_feedback_crop.bottom = _tmp15_;
	_tmp16_ = _data2_->temp_array[3];
	ns_widgets_feedback_crop.left = _tmp16_;
	__g_list_free__g_object_unref0_0 (sbtn_list);
...
void on_btn_yes_released (GtkButton* button, GtkGrid* grid_res, NSWidgetsFeedback* self) {
	...
	_tmp0_ = stdout;
	fprintf (_tmp0_, "button released\n");
	_tmp1_ = grid_res;
	ns_widgets_feedback_update_resolution_without_builder (self, _tmp1_);
	_tmp2_ = button;
	...
	box = _tmp4_;
	_tmp5_ = gtk_widget_get_parent ((GtkWidget*) box);
	_tmp6_ = _g_object_ref0 (_tmp5_);
	infbar_res_aa = _tmp6_;
	_tmp7_ = gtk_widget_get_parent (infbar_res_aa);
...
void on_btn_show_info_clicked (GtkButton* sender, NSWidgetsFeedback* self) {
	...
	_tmp19_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp18_, GTK_TYPE_BOX) ? ((GtkBox*) _tmp18_) : NULL);
	box = _tmp19_;
	_tmp20_ = box;
	...
	if (_tmp116_ > 0) {
		...
		_tmp125__length1 = sbtns_length1;
		{
			...
			for (spinbutton_it = 0; spinbutton_it < _tmp125__length1; spinbutton_it = spinbutton_it + 1) {
				...
				spinbutton = _tmp126_;
				{
					...
					_tmp130_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp129_, GTK_TYPE_ADJUSTMENT) ? ((GtkAdjustment*) _tmp129_) : NULL);
					crop_sbtn = _tmp130_;
					_tmp131_ = crop_sbtn;
		...
		_tmp134_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp133_, GTK_TYPE_ADJUSTMENT) ? ((GtkAdjustment*) _tmp133_) : NULL);
		adjust = _tmp134_;
		_tmp135_ = ((Main*) self)->builder;
		_tmp136_ = gtk_builder_get_object (_tmp135_, "e_end_min");
		_tmp137_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp136_, GTK_TYPE_ENTRY) ? ((GtkEntry*) _tmp136_) : NULL);
		entry = _tmp137_;
		_tmp138_ = adjust;
...
static void ns_widgets_feedback_update_resolution (NSWidgetsFeedback* self) {
	...
	_tmp2_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, GTK_TYPE_SPIN_BUTTON) ? ((GtkSpinButton*) _tmp1_) : NULL);
	height_sbtn = _tmp2_;
	_tmp3_ = ((Main*) self)->builder;
	_tmp4_ = gtk_builder_get_object (_tmp3_, "scale_scale");
	_tmp5_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp4_, GTK_TYPE_SCALE) ? ((GtkScale*) _tmp4_) : NULL);
	scale = _tmp5_;
...
static void ns_widgets_feedback_update_resolution_values (NSWidgetsFeedback* self, GtkSpinButton* height_sbtn, GtkScale* scale, GtkEntry* width_entry) {
	...
	_tmp12_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp11_, GTK_TYPE_ADJUSTMENT) ? ((GtkAdjustment*) _tmp11_) : NULL);
	adjust = _tmp12_;
...
static void ns_widgets_feedback_built_infbar_info_layout (NSWidgetsFeedback* self) {
	...
	((Main*) self)->infobar = _tmp0_;
	_tmp1_ = ((Main*) self)->infobar;
	_tmp2_ = gtk_info_bar_get_content_area (_tmp1_);
	_tmp3_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp2_, GTK_TYPE_CONTAINER) ? ((GtkContainer*) _tmp2_) : NULL);
	infobar_content = _tmp3_;
	...
	((Main*) self)->lbl_video = _tmp7_;
	_tmp8_ = (GtkLabel*) gtk_label_new ("");
	g_object_ref_sink (_tmp8_);
	_g_object_unref0 (((Main*) self)->lbl_audio);
	((Main*) self)->lbl_audio = _tmp8_;
	_tmp9_ = (GtkLabel*) gtk_label_new ("");
	g_object_ref_sink (_tmp9_);
	_g_object_unref0 (((Main*) self)->lbl_other);
	((Main*) self)->lbl_other = _tmp9_;
	_tmp10_ = ((Main*) self)->lbl_video;
	gtk_grid_attach (grid_video, (GtkWidget*) _tmp10_, 0, 0, 1, 4);
	_tmp11_ = ((Main*) self)->lbl_audio;
	gtk_grid_attach (grid_video, (GtkWidget*) _tmp11_, 1, 0, 1, 3);
	_tmp12_ = ((Main*) self)->lbl_other;
	gtk_grid_attach (grid_other, (GtkWidget*) _tmp12_, 2, 0, 1, 4);
	_tmp13_ = ((Main*) self)->infobar;
	gtk_widget_show ((GtkWidget*) _tmp13_);
	gtk_widget_show ((GtkWidget*) grid_video);
	_tmp14_ = ((Main*) self)->lbl_video;
	gtk_widget_show ((GtkWidget*) _tmp14_);
	gtk_widget_show ((GtkWidget*) grid_audio);
	_tmp15_ = ((Main*) self)->lbl_audio;
	gtk_widget_show ((GtkWidget*) _tmp15_);
	gtk_widget_show ((GtkWidget*) grid_other);
	_tmp16_ = ((Main*) self)->lbl_other;
	gtk_widget_show ((GtkWidget*) _tmp16_);
	_tmp17_ = ((Main*) self)->infobar;
	gtk_info_bar_add_button (_tmp17_, "Hide", (gint) GTK_RESPONSE_CLOSE);
	...
	_tmp18_ = ((Main*) self)->infobar;
	g_signal_connect_object (_tmp18_, "response", (GCallback) ___lambda6__gtk_info_bar_response, self, 0);
...
static gchar* ns_widgets_feedback_get_file (NSWidgetsFeedback* self) {
	...
	_tmp2_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, GTK_TYPE_FILE_CHOOSER_BUTTON) ? ((GtkFileChooserButton*) _tmp1_) : NULL);
	fbtn = _tmp2_;
...
void on_btn_help_clicked (GtkButton* sender, NSWidgetsFeedback* self) {
	...
	_tmp2_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, GTK_TYPE_BOX) ? ((GtkBox*) _tmp1_) : NULL);
	box = _tmp2_;
	_tmp3_ = box;
	_tmp4_ = gtk_container_get_children ((GtkContainer*) _tmp3_);
	children = _tmp4_;
	_tmp5_ = children;
	g_list_foreach (_tmp5_, ___lambda7__gfunc, self);
	_tmp6_ = ((Main*) self)->builder;
	...
	if (g_strcmp0 (_tmp16_, "other") == 0) {
		...
		_tmp19_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp18_, GTK_TYPE_WIDGET) ? ((GtkWidget*) _tmp18_) : NULL);
		ibar = _tmp19_;
		_tmp20_ = ibar;
		gtk_widget_hide (_tmp20_);
		_tmp21_ = ((Main*) self)->builder;
		_tmp22_ = gtk_builder_get_object (_tmp21_, "infbar_terminal");
		_tmp23_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp22_, GTK_TYPE_WIDGET) ? ((GtkWidget*) _tmp22_) : NULL);
		...
		_tmp27_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp26_, GTK_TYPE_WIDGET) ? ((GtkWidget*) _tmp26_) : NULL);
		_g_object_unref0 (ibar);
		ibar = _tmp27_;
		_tmp28_ = ibar;
	...
	_tmp40_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp39_, GTK_TYPE_WIDGET) ? ((GtkWidget*) _tmp39_) : NULL);
	infobar_f2theora = _tmp40_;
	_tmp41_ = ((Main*) self)->builder;
	_tmp42_ = gtk_builder_get_object (_tmp41_, "txb_f2theora_help");
	_tmp43_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp42_, GTK_TYPE_TEXT_BUFFER) ? ((GtkTextBuffer*) _tmp42_) : NULL);
...
void on_tbtn_show_filters_toggled (GtkToggleButton* sender, NSWidgetsFeedback* self) {
	...
	_tmp2_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, GTK_TYPE_TEXT_BUFFER) ? ((GtkTextBuffer*) _tmp1_) : NULL);
...
static void block3_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data3_->_ref_count_)) {
		NSWidgetsFeedback * self;
		self = _data3_->self;
		_g_object_unref0 (_data3_->advice_infobar);
		_g_object_unref0 (_data3_->sender);
		_g_object_unref0 (self);
...
static void __lambda8_ (Block3Data* _data3_) {
	...
	GtkButton* _tmp0_;
	self = _data3_->self;
	gtk_widget_destroy ((GtkWidget*) _data3_->advice_infobar);
	_tmp0_ = _data3_->sender;
...
void on_btn_advice_clicked (GtkButton* sender, NSWidgetsFeedback* self) {
	...
	_g_object_unref0 (_data3_->sender);
	_data3_->sender = _tmp1_;
	_tmp2_ = _data3_->sender;
	gtk_widget_set_sensitive ((GtkWidget*) _tmp2_, FALSE);
	_tmp3_ = (GtkInfoBar*) gtk_info_bar_new ();
	g_object_ref_sink (_tmp3_);
	_data3_->advice_infobar = G_TYPE_CHECK_INSTANCE_TYPE (_tmp3_, GTK_TYPE_INFO_BAR) ? ((GtkInfoBar*) _tmp3_) : NULL;
	_tmp4_ = ((Main*) self)->builder;
	_tmp5_ = gtk_builder_get_object (_tmp4_, "box_on_top_of_sbar");
	_tmp6_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp5_, GTK_TYPE_BOX) ? ((GtkBox*) _tmp5_) : NULL);
	box = _tmp6_;
	_tmp7_ = (GtkImage*) gtk_image_new_from_stock (GTK_STOCK_DIALOG_INFO, GTK_ICON_SIZE_DIALOG);
	g_object_ref_sink (_tmp7_);
	idea = _tmp7_;
	_tmp8_ = gtk_info_bar_get_content_area (_data3_->advice_infobar);
	_tmp9_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp8_, GTK_TYPE_CONTAINER) ? ((GtkContainer*) _tmp8_) : NULL);
	infobar_content = _tmp9_;
	gtk_widget_show ((GtkWidget*) box);
	g_signal_connect_data (_data3_->advice_infobar, "response", (GCallback) ___lambda8__gtk_info_bar_response, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
	gtk_info_bar_add_button (_data3_->advice_infobar, "Hide", (gint) GTK_RESPONSE_CLOSE);
	gtk_container_add (infobar_content, (GtkWidget*) idea);
	_tmp10_ = ((Main*) self)->advice_label;
	gtk_container_add (infobar_content, (GtkWidget*) _tmp10_);
	gtk_box_pack_end (box, (GtkWidget*) _data3_->advice_infobar, TRUE, TRUE, (guint) 5);
	gtk_widget_show ((GtkWidget*) idea);
	_tmp11_ = ((Main*) self)->advice_label;
	gtk_widget_show ((GtkWidget*) _tmp11_);
	gtk_widget_show ((GtkWidget*) _data3_->advice_infobar);
	_g_object_unref0 (infobar_content);
...
static void ns_widgets_feedback_finalize (GObject* obj) {
	NSWidgetsFeedback * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, NS_WIDGETS_TYPE_FEEDBACK, NSWidgetsFeedback);
...
static void _vala_ns_widgets_feedback_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	NSWidgetsFeedback * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, NS_WIDGETS_TYPE_FEEDBACK, NSWidgetsFeedback);
	switch (property_id) {
		default:
